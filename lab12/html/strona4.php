<!--zawartosc podstrony z wyjatkowymi mostami -->
<h2>
...
wojny światowe. <img src="../img/starymost.jpg" style="margin: 10px;  width: 400px;" ALIGN= "RIGHT"> 
...
Wpisany na listę UNESCO Most Karola w Pradze, to bez wątpienia jeden z najbardziej <img src="../img/mostswkarola.jpg" style="margin: 10px;  width: 400px;" ALIGN= "RIGHT"> rozpoznawalnych zabytków Europy. 
Średniowieczny kamienny most łączy praskie Stare Miasto z położoną na lewym brzegu Wełtawy dzielnicą Mała Strana.
	...
	<img src="../img/most_sw_aniola.jpg" style="margin: 10px;  width: 400px;" ALIGN= "RIGHT"> 
	...
	<h2>Ponte di Rialto – najstarszy most w Wenecji</h2>
	...
	Kolejne budowane tu drewniane przeprawy nie wytrzymywały ciężaru sklepików, <img src="../img/wenecja.jpg" style="margin: 10px;  width: 400px;" ALIGN= "RIGHT">towarów i przechodniów, zatem zdecydowano o budowie przeprawy murowanej. 
	...
	choć sam most czasem bywa mylnie nazywany “London Bridge”. <img src="../img/london.jpg" style="margin: 10px;  width: 400px;" ALIGN= "RIGHT">Choć Tower Bridge wygląda jakby stał w Londynie od wieków, to konstrukcja wiktoriańska. 
